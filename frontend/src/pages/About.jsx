    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          <img src={logo} alt="Esportorium" className="mb-5 h-20 w-20 rounded-2xl shadow-md" />
              ...
              <div key={phase.phase} className="flex gap-5">
                ...
                <div className="pb-6">
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <Badge variant={phase.status === 'current' ? 'current' : 'secondary'} className="text-xs">
        ...
        <section className="rounded-xl bg-muted p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link to="/submit">
              <Button>Submit a Tournament</Button>
            </Link>
            <Link to="/docs">
